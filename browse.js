...
var oldie1 = {
  name: "Mags Bennett",
  pic: "http://static.boredpanda.com/blog/wp-content/uploads/2014/11/old-people-funny-t-shirts-19__605.jpg",
...
var oldie2 = {
  name: "Abe Simpson",
  pic: "https://bestepisodeever.files.wordpress.com/2015/03/1f21a.png",
...
var oldie3 = {
  ...
  pic: "http://i.dailymail.co.uk/i/pix/2010/11/10/article-0-0BFD933C000005DC-405_468x313.jpg",
...
var oldie5 = {
  name: "Arthur Bateman",
  pic: "http://www.allgirlsallowed.org/sites/default/files/imagecache/screen/shrinking%20ageing.jpg",
...
var oldie6 = {
  name: "Popcorn Sutton",
  pic: "https://westernrifleshooters.files.wordpress.com/2015/01/popcorn-gives-the-finger.jpg",
...
var oldie7 = {
  ...
  pic: "http://cdn.theatlantic.com/assets/media/img/mt/2015/09/RTX1SXT6/lead_960.jpg?1443650308",
...
var oldie8 = {
  ...
  pic: "https://c1.staticflickr.com/5/4104/4952586576_3e0c73dc44.jpg",
...
var oldie9 = {
  name: "Joe Shepherd",
  pic: "http://nashvillesoftwareschool.com/images/instructors/joe.jpg",
  about: "Joe's alright",
  fee: "meh, best offer"
};
...
for ( var i = 0; i < productsArray.length; i++ ) {
  ...
  var pic = "<img class='browseIMG' src='" + currentOldie.pic + "'>";
  var about = "<h5>" + "About: " + currentOldie.about + "</h5>";
  var fee = "<h5>" + "Adoption Fee: " + currentOldie.fee + "</h5>";

  nextOldie.innerHTML += "<div class='card'>" + name + pic + about + fee + "</div>";
};
